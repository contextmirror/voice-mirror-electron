...
> **ARCHIVED 2026-07-02** — dated 2026-03-04 point-in-time snapshot; moved out of
> `docs/source-of-truth/`. For current feature/UX gap status see
> [`docs/source-of-truth/IDE-GAPS.md`](../source-of-truth/IDE-GAPS.md).
>
