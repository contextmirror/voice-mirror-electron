...
> **ARCHIVED 2026-07-02** — the work tracked here is complete (37/37). Superseded by
> [`docs/source-of-truth/LSP.md`](../source-of-truth/LSP.md). Kept for the
> configuration-alignment detail and the wave-by-wave closure log.
>
...
| `docs/implementation/LSP-DESIGN.md` | Keep (architecture/data-flow reference) | ✅ Kept at the time; since archived as `2026-02-28-lsp-design.md` |
