//! SHA-256, hex encoding, and base64 utilities for Edge TTS DRM.
//!
//! Minimal inline implementations to avoid adding `sha2` as a dependency
//! just for the DRM token generation.
